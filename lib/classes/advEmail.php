<?php
  ...
  */
  ...
  {  
    ...
    private $_attachDisplayName	= array();
    ...
    private $_smtpUser      = '';
    private $_systemEmail   = 'guyver4@guyver4.co.uk';
    private $_subject       = '';
    private $_userAgent     = 'guyver4.co.uk';
    ...
    */
    private function _buildMessage()
    {
      ...
      for ($i=0; $i < count($this->_attachName); $i++)
      {
        ...
        if($this->_attachDisplayName[$i]!==null && $this->_attachDisplayName[$i]!=="")
        	$basename = $this->_attachDisplayName[$i];
        else
